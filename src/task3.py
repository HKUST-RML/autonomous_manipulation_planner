...
if __name__ == '__main__':
    ...
    initial_object_vertex_position = [[1,0.7], [1,0], [2.5,0], [2.5,0.7]]
    initial_CoM_position = [1.75, 0.35]
    ...
    target_object_vertex_position = [[1,1.495], [1.495,1], [2.556,2.06], [2.06,2.556]]
    target_finger_position = None
    try:
        total_object_pose_trajectory, total_finger_position_trajectory = framework(initial_object_vertex_position, initial_CoM_position, initial_gripper_finger_position, target_object_vertex_position, target_finger_position, environment, 'Type 2', mu_gripper=0.6, mu_environment=0.03)
        while True:
